...
`spkc83/retail-bank-servicing-agent-9b-peft-v10-longctx@055ce38...`
(published with `adapter_config.json` under `adapter/`; set `RETAIL_BANK_ADAPTER_SUBFOLDER=adapter`).
The previously deployed adapter was `spkc83/retail-bank-servicing-agent-9b-peft-v8-natural-generation@badbc05...`.
